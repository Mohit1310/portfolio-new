    ...
    <section className="my-8 overflow-hidden rounded-lg border border-(--line)">
      ...
      <div className="p-4 md:p-5">
        <div className="flex items-center justify-between text-sm">
          <span className="text-(--text-muted)">Graph size</span>
        ...
        <input
          ...
          className="mt-2 w-full accent-(--text-primary)"
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2">
          <div className="rounded-md border border-(--line) bg-(--surface) p-4">
            <div className="flex items-center justify-between gap-2">
              ...
              <span className="rounded border border-(--line-strong) px-2 py-0.5 text-[10px] font-medium text-(--text-muted)">
                chosen in 2010
              </span>
            </div>
            ...
            <div className="mt-3">
              ...
              <div className="relative mt-1 h-3 overflow-hidden rounded-full border border-(--line) bg-(--bg)">
                <div
                  className="h-full rounded-full"
                  style={{
                    width: `${ramPct}%`,
                    backgroundColor: fits ? 'var(--text-primary)' : '#d97706',
                  }}
                />
              </div>
            </div>
        ...
        <p className="mt-4 rounded-md border border-(--line) bg-(--surface) px-3 py-2 text-xs leading-relaxed text-(--text-muted) md:text-sm">
          {fits
